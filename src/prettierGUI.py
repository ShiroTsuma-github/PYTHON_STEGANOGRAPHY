...
class Button_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.encode = customtkinter.CTkButton(self, text="Encode", command=self.encode_callback, height=80)
        self.encode.grid(row=0, column=0, padx=10, pady=(10, 10), sticky="nsew", columnspan=2)
        self.decode = customtkinter.CTkButton(self, text="Decode", command=self.decode_callback, height=80)
        self.decode.grid(row=1, column=0, padx=10, pady=(10, 10), sticky="nsew", columnspan=2)
...
class Randomise_Space(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master)
        self.randomise_image = customtkinter.CTkImage(Image.open(f"{ROOT_DIR}/resources/images/png1.png"), size=(25, 25))
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.image_frame = ImageFrameAndDropPoint(self)
